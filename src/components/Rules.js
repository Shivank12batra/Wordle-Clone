  ...
  return (
    <div className='rules'>
        <div>
            ...
            <p>• <span style={{'color':'#5ac85a', 'fontWeight':'bold'}}>Green:</span> Correct Guess, <span style={{'color':'#e2cc68', 'fontWeight':'bold'}}>Yellow</span>  Correct Guess, Wrong Position, <span style={{'color':'#a1a1a1', 'fontWeight':'bold'}}>Grey:</span> Not In Wordle</p>
